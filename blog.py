...
def create_blog_page():
    ...
    subtitle_label = tk.Label(subtitle_frame,text="Weekly Articles with Insight and the weekends Message",font=("Helvetica", 18),fg="#333333",bg="#f5f5f5")
    ...
    desc_label = tk.Label(
        desc_frame,
        text="Our blog takes the message from the weekend and lays out next right steps\nso you can hear a message in practical ways",font=("Helvetica", 16),
        fg="#555555",
        bg="#f5f5f5",
        justify="left"
    )
    ...
    for img in image_names:
        full_path = os.path.join("C:/Pyhton project", img)
