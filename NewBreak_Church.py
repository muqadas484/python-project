...
def home_main():
    ...
    # Add a "Be Our Guest" button
    guest_button = tk.Button(header, text="Be our guest"   , bg="#007ACC", fg="white", font=('open sans', 10, 'bold'),
                             padx=10, pady=8, relief='raised', bd=2)
    ...
    # Footer title
    footer_title = tk.Label(window, text="One Church. Many Locations.", fg='white', bg="#333333",
                            font=('Arial', 12, 'bold'))
